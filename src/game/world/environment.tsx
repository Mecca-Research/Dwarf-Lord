...
export function Environment() {
  ...
  return (
    <group>
      ...
      <CanvasTent x={-5.8} z={8.15} rot={0.2} scale={1.15} />
      <CanvasTent x={-2.2} z={10.4} rot={-0.3} scale={0.95} />
      <CanvasTent x={6.55} z={9.05} rot={-0.3} scale={0.95} />
      <Kitchen x={2} z={6.5} />
      ...
      <Crate x={5.15} z={4.55} s={0.82} rot={0.25} />
      <Crate x={5.55} z={4.95} s={0.68} rot={0.25} />
      <Crate x={8.65} z={4.65} s={0.9} rot={0.25} />
      <Crate x={-8.7} z={6.15} s={0.78} rot={0.25} />
