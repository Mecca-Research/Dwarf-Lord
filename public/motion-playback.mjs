// Generated by scripts/sync-motion-playback.mjs; edit src/game/motion-playback.ts.
...
export class MotionPlayback {
    ...
    travel(distance, strideLength) {
        ...
        if (!isTravelMotion(this.manifest))
            throw new Error('Only walking motions accept travel');
